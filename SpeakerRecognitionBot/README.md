...
- In a terminal, navigate to `SpeakerRecognitionBot`

    ```bash
    # change into project folder
    cd SpeakerRecognitionBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `SpeakerRecognitionBot` folder
  - Select `SpeakerRecognitionBot.csproj` file
